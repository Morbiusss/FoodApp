...
const b_items=[{
  ...
  price:'50 for One',
  src:'https://b.zmtcdn.com/data/dish_photos/259/0fda922de1a4bb811d947618767a8259.jpg?output-format=webp'
},
{
  name:"Puri",
...
const Lunch = () => {
  ...
  <div
    ...
    <div class="p-6">
      ...
      <button
        type="button"
        class="inline-block rounded bg-pink-900 hover:bg-pink-600 px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] "
        >
        {item.price}
      </button>
    </div>
